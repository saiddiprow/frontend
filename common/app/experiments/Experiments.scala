...
object ABJavascriptRendering extends Experiment(
  name = "ab-javascript-rendering",
  description = "Users in this experiment will see pages rendered by the javascript renderer.",
